...
if __name__ == '__main__':
    # 15-10-07
    mdl = fit_bncnn([0, 1, 2, 3, 4], ['naturalscene'], '15-10-07', l2_reg=0.02, description='bn_cnn layer norm (softplus)')
    ...
    mdl = fit_bncnn(gc_151121a, ['naturalscene'], '15-11-21a', l2_reg=0.05, description='bn_cnn layer norm (softplus)')
    ...
    mdl = fit_bncnn(gc_151121b, ['naturalscene'], '15-11-21b', l2_reg=0.05, description='bn_cnn layer norm (softplus)')
